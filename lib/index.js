...
var Suggestrap = function () {
  function Suggestrap(req) {
    ...
    this.keyUpHandler = _lodash2.default.debounce(function (event) {
      if (_this.isReadyToShow(event.target)) {
        // Show suggestions
  ...
  _createClass(Suggestrap, [{
    ...
    key: 'isReadyToShow',
    value: function isReadyToShow(element) {
      return document.activeElement.id == this.req['target'] && element.value.length >= this.option['minlength'] && element.value != this.state['query'];
    }
  }, {
    key: 'hasValues',
    ...
    value: function hasUrl() {
      ...
      return 'values' in this.req && typeof this.req.values == 'string' && pattern.test(this.req.values) || 'url' in this.req && typeof this.req.url == 'string' && pattern.test(this.req.url);
    }
  }, {
    key: '_fetchJson',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(8)(module)))
...
var _suggestrap = __webpack_require__(6);
