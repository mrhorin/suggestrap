...
module.exports = _suggestrap2.default;
...
var Suggestrap = function () {
  function Suggestrap(req) {
    ...
    this.keyUpHandler = _lodash2.default.debounce(function (event) {
      if (_this._isReadyToShow()) {
        // Show suggestions
        _this.state['query'] = event.target.value;
        if (_this.hasUrl()) {
          _this._fetchJson(function (json) {
            if (json.length > 0) {
              _this._add(json);
              _this.show();
            }
          ...
          if (_this.req.values.length > 0) {
            _this._add(_this.suggestions);
            _this.show();
          }
        }
      } else {
  ...
  _createClass(Suggestrap, [{
    ...
    value: function show() {
      ...
      var rect = this.element['target'].getBoundingClientRect();
      var x = window.pageXOffset + rect.left;
      var y = window.pageYOffset + rect.top + rect.height;
    ...
    value: function hasValues() {
      return 'values' in this.req && _typeof(this.req.values) == 'object' && this.req.values.length > 0;
    }
  }, {
    key: 'hasUrl',
    value: function hasUrl() {
      return 'values' in this.req && typeof this.req.values == 'string' && this._validateUrl(this.req.values) || 'url' in this.req && typeof this.req.url == 'string' && this._validateUrl(this.req.url);
    }
  }, {
    key: '_isReadyToShow',
    value: function _isReadyToShow() {
      return document.activeElement.id == this.req.target && this.element.target.value.length >= this.option.minlength && this.element.target.value != this.state.query;
    }
  }, {
    key: '_add',
    value: function _add(json) {
      var _this2 = this;
    ...
    key: '_activeCurrentSuggest',
    value: function _activeCurrentSuggest() {
    ...
    key: '_fetchJson',
    value: function _fetchJson(callbackFunc) {
      var _this3 = this;
    ...
    value: function _reqInitialize(req) {
      ...
      } else if ('values' in req && typeof req['values'] != 'string' && _typeof(req['values']) != 'object') {
    ...
    value: function _elementInitialize() {
      ...
      if (this.option.id) {
        ...
        var suffix = 2;
        while (document.getElementById('suggestrap_' + suffix)) {
          suffix++;
    ...
    get: function get() {
      ...
      if (this.req.values && this.state.query) {
        var pattern = new RegExp(this.state.query, 'i');
        for (var index = 0; index < this.req.values.length && res.length < this.option.count; index++) {
