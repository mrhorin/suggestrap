...
var Suggestrap = function () {
  ...
  _createClass(Suggestrap, [{
    ...
    value: function hasUrl() {
      return 'values' in this.req && typeof this.req.values == 'string' && this.validateUrl(this.req.values) || 'url' in this.req && typeof this.req.url == 'string' && this.validateUrl(this.req.url);
    }
  }, {
    key: 'validateUrl',
