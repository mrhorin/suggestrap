...
var getEnumerableProperties = __webpack_require__(33);
var config = __webpack_require__(2);
...
var getProperties = __webpack_require__(23);
var isProxyEnabled = __webpack_require__(7);
...
var Suggestrap = function () {
  function Suggestrap(req) {
    var _this = this;

    var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, Suggestrap);
    ...
    this.hide();
    this.keyUpHandler = _lodash2.default.debounce(function (event) {
      if (document.activeElement.id == _this.req['target'] && event.target.value.length >= _this.option['minlength'] && event.target.value != _this.state['query']) {
        _this.state['query'] = event.target.value;
        _this._fetchSuggestJson(function (json) {
          if (json.length > 0) {
            _this.add(json);
            _this.show();
          }
  ...
  _createClass(Suggestrap, [{
    ...
    key: 'moveDownSuggest',
    value: function moveDownSuggest() {
      if (this.state['isShow']) {
    ...
    key: 'activeCurrentSuggest',
    value: function activeCurrentSuggest() {
      for (var i = 0; i < this.element['suggest'].childNodes.length; i++) {
    ...
    value: function add(json) {
      ...
      try {
        for (var _iterator = this._parseJson(json)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var val = _step.value;
          ...
          suggestItem.addEventListener('click', function (event) {
            _this2.element['target'].value = event.target.innerHTML;
            _this2.hide();
          });
    ...
    key: '_fetchSuggestJson',
    value: function _fetchSuggestJson(callbackFunc) {
      var _this3 = this;

      new Promise(function (resolve, reject) {
        _superagent2.default.get(_this3.jsonUrl).end(function (err, res) {
          if (err) {
            reject(err);
          } else {
            resolve(res);
    ...
    value: function _setEventListener() {
      ...
      this.element['target'].addEventListener('keyup', function (event) {
        var invalidKeyCode = [38, 40, 37, 39, 16, 17, 13];
        var keyCode = event.keyCode;
        if (!invalidKeyCode.includes(keyCode)) {
          // When valid key
          _this4.keyUpHandler(event);
        } else if (keyCode == 38) {
          // When press Up key
          _this4.moveUpSuggest();
        } else if (keyCode == 40) {
          // When press Down key
          _this4.moveDownSuggest();
        } else if (keyCode == 13) {
          // When press Enter key
          if (_this4.state['isShow'] && _this4.state['currentIndex'] != -1) {
            _this4.hide();
          } else {
            _this4.keyUpHandler(event);
          }
      ...
      this.element['target'].addEventListener('blur', function (event) {
      ...
      this.element['target'].addEventListener('focus', function (event) {
        _this4.keyUpHandler(event);
      });
      // Solve that the target can't fire keyup event when do auto correct in Mobile Safari
      this.element['target'].addEventListener('textInput', function (event) {
        _this4.keyUpHandler(event);
      });
    }
  }, {
    ...
    key: '_reqInitialize',
    value: function _reqInitialize(req) {
      // Necessary params
    ...
    key: '_optionInitialize',
    value: function _optionInitialize(option) {
      // Set default options
    ...
    key: '_stateInitialize',
    value: function _stateInitialize() {
      return this.state = { query: '', isShow: false, length: 0, currentIndex: -1 };
    }
  }, {
    key: '_elementInitialize',
    value: function _elementInitialize() {
      var element = {
...
var shouldRetry = __webpack_require__(18);
...
var _chai = __webpack_require__(27);

var _suggestrap = __webpack_require__(10);

var _suggestrap2 = _interopRequireDefault(_suggestrap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

describe('Suggestrap', function () {
  var req = {
    target: "target",
  ...
  beforeEach(function (done) {
    s = new _suggestrap2.default(req);
    done();
  });

  context('when added JSON', function () {
    ...
    describe('#add', function () {
      it('should have 2 as state.length', function () {
        _chai.assert.equal(s.state.length, 2);
      });
    });

    describe('#remove', function () {
      it('should have 0 as state.length', function () {
        s.remove();
        _chai.assert.equal(s.state.length, 0);
      });
    });

    describe('#show', function () {
      it('should have true as state.isShow', function () {
        s.show();
        _chai.assert.isTrue(s.state.isShow);
      });
    });

    describe('#hide', function () {
      it('should have false as state.isShow', function () {
        s.hide();
        _chai.assert.isFalse(s.state.isShow);
      });
    });
  });
  ...
  describe('#_parseJson', function () {
    ...
    it('should return Array when Array of JSON', function () {
      json = JSON.stringify([{ id: 1, name: 'Yamada' }, { id: 2, name: 'Kato' }]);
      _chai.assert.isArray(s._parseJson(json));
    });

    it('should return Object when Hash of JSON', function () {
      json = JSON.stringify({ id: 1, name: 'Yamada' });
      _chai.assert.isObject(s._parseJson(json));
    });
    ...
    it('should thrrow SyntaxError when wrong format string', function () {
      json = "[{ id: 1, name: 'Yamada', }, { id: 2, name: 'Kato', }]";
...
var pathval = __webpack_require__(29);
...
exports.eql = __webpack_require__(34);
...
exports.compareByInspect = __webpack_require__(41);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(25);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(42);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(43);

/*!
 * Proxify util
 */

exports.proxify = __webpack_require__(9);

/*!
 * addLengthGuard util
 */

exports.addLengthGuard = __webpack_require__(8);

/*!
 * isProxyEnabled helper
 */

exports.isProxyEnabled = __webpack_require__(7);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(44);
...
var addLengthGuard = __webpack_require__(8);
var chai = __webpack_require__(1);
var flag = __webpack_require__(0);
var proxify = __webpack_require__(9);
var transferFlags = __webpack_require__(3);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(25);
